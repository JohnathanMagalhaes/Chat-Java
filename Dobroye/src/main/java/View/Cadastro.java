...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (validarCampos() == true) {
            ...
            if (usu.VerificarEmailExiste(txtEmail.getText())) {
                JOptionPane.showMessageDialog(this, "E-mail informado já está cadastrado!");
            } else {
                String sexo;
                ...
                boolean resultado = usu.salvar(pessoa);

                if (resultado == true) {
                    JOptionPane.showMessageDialog(this, "Usuário cadastrado com sucesso :D");
                } else {
                    JOptionPane.showMessageDialog(this, ":(, Infelizmente ocorreu um error ao realizar o seu cadastro. Por favor tente novamente mais tarde ;D");
                }
            }
        }
